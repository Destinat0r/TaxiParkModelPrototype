...
public class CarsInitializer {
    ...
    public static PassengerCar[] initPassengerCarsFromJsonFile() {
        return JsonLoader.loadFromJson(RESOURCE_MANAGER.getParameter(ConfigConstants.PATH_JSON_PASSENGER_CARS), PassengerCar[].class);
    }

    public static Truck[] initTrucksFromJsonFile() {
        return JsonLoader.loadFromJson(RESOURCE_MANAGER.getParameter(ConfigConstants.PATH_JSON_TRUCKS), Truck[].class);
    }
}
